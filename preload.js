...
contextBridge.exposeInMainWorld('pawback', {
  ...
  generalStart:    ()     => ipcRenderer.send('general-start'),
  generalPause:    ()     => ipcRenderer.send('general-pause'),
  generalResume:   ()     => ipcRenderer.send('general-resume'),
  generalStop:     ()     => ipcRenderer.send('general-stop'),
  generalAckEnd:   ()     => ipcRenderer.send('general-ack-end'),
  pomodoroAckSessionEnd: () => ipcRenderer.send('pomodoro-ack-session-end'),
  pomodoroAckFinal:      () => ipcRenderer.send('pomodoro-ack-final'),
  ...
  quickContract:       (task)          => ipcRenderer.send('quick-contract', { task }),
  startRecallMode:     (intervalMin)   => ipcRenderer.send('start-recall-mode', { intervalMin }),
  stopRecallMode:      ()              => ipcRenderer.send('stop-recall-mode'),
  onRecallPrompt:      (cb)            => safeOn('recall-prompt', () => cb()),
  getHoverMessage:     (context)       => ipcRenderer.invoke('get-hover-message', context),
  ...
  getSubjectLog:       () => ipcRenderer.invoke('get-subject-log'),
